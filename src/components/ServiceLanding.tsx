  ...
  return <article>
    ...
    <section className="bg-gradient-to-br from-brand-dark to-brand px-6 py-14 text-white md:py-20">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="text-sm font-bold tracking-widest text-brand-light">{category.title}</p>
        ...
        <div className="mt-5 max-w-3xl text-base sm:text-lg leading-relaxed text-white/90">
          {introParts.length === 2 ? (
            ...
            <p className="leading-relaxed">{introText.replace(/\.+$/, "")}</p>
          )}
        </div>
        <Link href="/contact/" className="mt-8 inline-block rounded-full bg-white px-6 py-3 font-bold text-brand-dark">상담 준비 항목 확인 →</Link>
      </div>
    </section>
    <div className="mx-auto grid max-w-5xl gap-8 px-6 py-12 md:grid-cols-[170px_1fr]">
      ...
      <div className="space-y-12 text-base leading-8 text-gray-700">
        ...
        <section id="estimate" className="scroll-mt-36">
          ...
          <p className="mt-4 text-[13.5px] sm:text-[14px] md:text-[14.5px] leading-relaxed tracking-tight text-gray-700">
          ...
          <p className="mt-3 text-[13.5px] sm:text-[14px] md:text-[14.5px] leading-relaxed tracking-tight text-gray-700">
