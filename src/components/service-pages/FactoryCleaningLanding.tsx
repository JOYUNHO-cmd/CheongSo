...
const faqItems: [string, string][] = [
  ...
  ["공장 바닥에 폐유나 정체를 모르는 분진이 있어도 청소하나요?", "물질의 종류와 현장 관리 기준을 먼저 확인해야 합니다. 일반 기름때·분진과 별도 취급이 필요한 물질을 구분하며, 모든 산업 오염이나 폐기물을 일괄 처리한다고 약속하지 않습니다."],
    ...
    <article className={`${readability.landing} ${readability.enhanced}`}>
      ...
      <section className="relative flex min-h-[calc(66.667vw+680px)] flex-col overflow-hidden bg-gradient-to-br from-brand-dark to-brand px-6 py-14 text-white md:min-h-[max(650px,50vw)] md:justify-center md:py-20 lg:min-h-[max(620px,50vw)]">
        <div className="relative -mx-6 -mt-14 aspect-[3/2] md:absolute md:inset-0 md:m-0 md:aspect-auto">
          <Image src="/images/hero-bg/factory-hero.webp" alt="" fill className="scale-110 object-cover blur-2xl" sizes="25vw" />
          <div className="absolute inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:aspect-[3/2] md:w-3/4 md:-translate-x-1/2 md:-translate-y-1/2">
            <Image src="/images/hero-bg/factory-hero.webp" alt="" fill priority className="object-cover" sizes="(min-width: 768px) 75vw, 100vw" />
          </div>
        ...
        <div className="relative mx-auto my-auto w-full max-w-5xl pt-8 md:pt-0">
          ...
          <h1 className="mt-4 text-3xl font-black leading-tight md:text-5xl">공장 바닥의 기름때·분진부터 유니트쿨러와 기계설비까지</h1>
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <ReadingParagraph>공장 바닥에 쌓인 기름때와 분진, 창고 통로 오염을 생산 일정에 맞춰 정리합니다. 찐청소는 유니트쿨러 내부·외부 세척과 기계설비청소도 상담하며, 공간 청소와 설비별 작업 비용을 나눠 안내합니다.</ReadingParagraph>
          </div>
      ...
      <div className={readability.layout}>
        ...
        <div className={`${readability.body} space-y-14 text-gray-800`}>
          ...
          <section id="estimate" className="scroll-mt-36">
            ...
            <ReadingParagraph>공장청소 비용은 면적만으로 결정하기 어렵습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4" breakAfter={["같은 100평이라도 "]}>같은 100평이라도 비어 있는 창고와 기계·자재가 빽빽한 생산구역은 작업량이 다릅니다. 가벼운 먼지가 있는 바닥과 기름때가 오래 쌓인 바닥도 필요한 작업이 같지 않습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4" breakAfter={["참고하되, "]}>찐청소는 면적을 참고하되, 실제로 필요한 인원과 장비·약품을 중심으로 견적을 산정합니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">평수보다 작업 조건이 중요한 경우가 있습니다</h3>
            <ReadingParagraph className="mt-2">넓고 비어 있는 공간은 장비 이동이 수월할 수 있습니다. 반대로 좁더라도 설비 사이를 나누어 작업하거나 물 사용을 제한해야 하는 공간은 더 많은 시간과 준비가 필요할 수 있습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">평수는 같아도 청소할 일까지 같지는 않습니다. 얼마나 넓은지와 함께, 어떻게 청소해야 하는지를 확인합니다.</ReadingParagraph>
            ...
            <ReadingParagraph className="mt-2">설비 청소는 바닥 면적보다 설비 자체의 상태와 구조가 중요합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">유니트쿨러는 수량, 크기, 설치 높이, 내부 오염과 접근 조건을 확인합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">기계설비는 종류와 수량, 청소할 부위, 내부 접근이나 분해 필요 여부를 확인합니다. 같은 수량이라도 작업 내용이 다르면 비용이 달라질 수 있습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">공간 청소와 설비 청소를 함께 요청하시면 항목을 구분해 견적을 안내합니다.</ReadingParagraph>

            <h3 className="mt-8 text-lg font-bold text-brand-dark">정기청소는 인원과 작업 시간을 기준으로 합니다</h3>
            <ReadingParagraph className="mt-3">정기청소는 필요한 인원과 시간당 작업 비용을 바탕으로 방문 주기와 회차별 범위를 정합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-3">오염이 자주 생기는 통로와 설비 주변, 사용 빈도가 낮은 창고 구역을 구분해 관리 계획을 세웁니다.</ReadingParagraph>
            <ReadingParagraph className="mt-3">유니트쿨러나 기계설비 세척이 필요하다면 일반 공간 청소와 구분해 작업 주기와 범위를 정합니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="scope" className="scroll-mt-36">
            ...
            <h3 className="mt-6 text-lg font-bold text-brand-dark">유니트쿨러 내부와 기계설비 분해 세척은 구분합니다</h3>
            <ReadingParagraph className="mt-2 mb-6">유니트쿨러는 내부 세척까지 진행합니다. 기계설비의 내부·분해 세척은 종류와 구조에 따라 가능 여부가 달라집니다. 안전한 설비 정지, 세척 가능 부위, 분해·재조립 담당과 재가동 확인 주체를 사전에 정합니다.</ReadingParagraph>
            <ReadingParagraph>공장청소는 요청하신 구역과 설비를 기준으로 범위를 정합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4">아래 작업이 모든 견적에 자동으로 포함되는 것은 아닙니다. 공간 청소, 유니트쿨러 세척, 기계설비청소 중 필요한 항목을 선택해 상담할 수 있습니다.</ReadingParagraph>
            ...
            <div className="mt-6 space-y-6">
              {scopeItems.map(item => (
                <div key={item.title} className={`${readability.scopeCard} rounded-xl border border-gray-100 p-5`}>
                  ...
                  {item.title === "기계설비청소" && (
                    <>
                      <ReadingParagraph className="mt-3 font-bold text-brand-dark">작업 전 확인하는 내용</ReadingParagraph>
          ...
          <section id="extra" className={`${readability.extraCosts} scroll-mt-36`}>
            ...
            <ReadingParagraph>유니트쿨러와 기계설비청소는 기본 공간 청소와 구분해 견적에 반영합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4">그 밖에 처음 정한 범위보다 작업이 늘어나거나 별도 공정이 필요한 경우에도 비용이 달라질 수 있습니다.</ReadingParagraph>
            ...
            <div className="mt-6 rounded-xl bg-gray-50 p-5">
              <ReadingParagraph className="font-bold text-brand-dark">다음 항목은 일반 청소와 구분해 수행 가능 여부부터 확인합니다</ReadingParagraph>
            ...
            <ReadingParagraph className="mt-5 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">견적을 비교할 때는 총금액과 함께 세척 부위, 분해 범위, 오염물 회수·처리 범위도 확인해 주세요.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="process" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2">면적과 오염 정도뿐 아니라 설비 수량, 내부 접근 조건, 분해 여부, 투입 인원에 따라 달라집니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">청소 시간 외에도 자재 이동, 안전조치, 재조립, 건조와 검수에 필요한 시간을 고려해야 합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">생산이나 설비 사용을 다시 시작해야 하는 시간이 있다면 상담 시 함께 알려주세요.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="cases" className="scroll-mt-36">
            ...
            <ReadingParagraph>공장청소 결과는 전체 모습과 주요 오염 구간을 함께 살펴보는 것이 좋습니다.</ReadingParagraph>
            <ul className="mt-4 grid gap-2.5 sm:grid-cols-2">
              {caseChecklist.map(item => (
                <li key={item} className="rounded-xl border border-gray-100 bg-gray-50/60 px-4 py-3">{item}</li>
              ))}
            </ul>
            <ReadingParagraph className="mt-5 text-[15px] text-gray-500">가능한 한 비슷한 위치와 조명에서 전후 상태를 비교하면 결과를 확인하기 쉽습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">바닥은 반짝임만으로 평가하지 않습니다. 설비 역시 외관이 깨끗해졌다는 것과 성능 점검·수리가 완료됐다는 것은 다른 의미입니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">사진이나 완료 자료가 필요하면 촬영할 구역과 제출 형식을 미리 알려주세요. 제공 가능 범위를 확인해 안내합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">생산 공정과 제품, 설비 배치 등 촬영이 제한되는 내용은 현장 규정을 먼저 확인합니다.</ReadingParagraph>
          ...
          <section id="area" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-4">공장청소는 언제 시작할지와 함께 언제 다시 사용할지를 맞추는 것이 중요합니다.</ReadingParagraph>
            <ul className="mt-4 grid gap-2.5 sm:grid-cols-2">
              {reservationChecklist.map(item => (
                <li key={item} className="rounded-xl border border-gray-100 bg-gray-50/60 px-4 py-3">{item}</li>
              ))}
            </ul>
            <ReadingParagraph className="mt-5">주말이나 휴무일 작업을 원하시면 희망 시간대를 알려주세요. 현장 조건과 예약 상황에 따라 가능 여부를 안내합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">생산 중 작업은 청소 구역을 분리할 수 있는지 등 현장 조건을 확인한 뒤 판단합니다.</ReadingParagraph>
          ...
          <section id="checkup" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2">견적서나 작업 범위에 포함된 구역과 설비, 세척 항목을 기준으로 결과를 확인합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">특히 처음 상담할 때 말씀하신 오염과 접근이 어려웠던 부분을 함께 살펴봅니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">오염과 기존 손상은 구분합니다</h3>
            <ReadingParagraph className="mt-2">바닥에 스며든 흔적, 코팅 벗겨짐, 마모, 부식이나 파손은 세척만으로 원래 상태가 되지 않을 수 있습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">추가 청소가 필요한 부분과 정비·보수가 필요한 상태를 구분해 안내합니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">반복되는 오염은 발생 원인도 살펴야 합니다</h3>
            <ReadingParagraph className="mt-2">누유나 분진 발생이 계속되면 청소 후에도 같은 구역에 오염이 다시 쌓일 수 있습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">발생 원인에 대한 조치와 청소 주기를 함께 검토하면 관리 기준을 세우는 데 도움이 됩니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">추가 확인이 필요한 곳은 알려주세요</h3>
            <ReadingParagraph className="mt-2">작업 범위 안에서 미흡한 부분이 보이면 해당 위치와 상태를 알려주세요.</ReadingParagraph>
          ...
          <section id="prep" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-5 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">청소를 위해 기계를 미리 분해해 두실 필요는 없습니다. 어디까지 분해할지, 누가 다시 조립하고 확인할지부터 맞추는 것이 먼저입니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="contact" className="scroll-mt-36">
            <div className="rounded-2xl bg-brand-dark p-7 text-white">
              <ReadingParagraph className="text-xl font-bold">공장청소 견적 문의</ReadingParagraph>
              <ReadingParagraph className="mt-3 text-white/80">몇 평인지와 함께, 어떤 공간과 설비를 청소할지 알려주세요.</ReadingParagraph>
              <ReadingParagraph className="mt-2 text-white/80">비어 있는 창고인지, 기름때가 쌓인 생산구역인지, 유니트쿨러 내부나 기계 분해 세척까지 필요한지에 따라 준비가 달라집니다.</ReadingParagraph>
