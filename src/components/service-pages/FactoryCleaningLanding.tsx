      ...
      <section className="relative overflow-hidden px-6 py-14 text-white md:py-20">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <p>공장 바닥에 쌓인 기름때와 분진, 창고 통로 오염을 생산 일정에 맞춰 정리합니다. 찐청소는 유니트쿨러 내부·외부 세척과 기계설비청소도 상담하며, 공간 청소와 설비별 작업 비용을 나눠 안내합니다.</p>
          </div>
      ...
      <div className="mx-auto grid max-w-5xl gap-8 px-6 py-12 md:grid-cols-[190px_1fr]">
        ...
        <div className="space-y-14 text-[17px] leading-8 text-gray-800">
          ...
          <section id="scope" className="scroll-mt-36">
            ...
            <p className="mt-2 mb-6">유니트쿨러는 내부 세척까지 진행합니다. 기계설비의 내부·분해 세척은 종류와 구조에 따라 가능 여부가 달라집니다. 안전한 설비 정지, 세척 가능 부위, 분해·재조립 담당과 재가동 확인 주체를 사전에 정합니다.</p>
