    ...
    <article>
      ...
      <section className="relative overflow-hidden px-6 py-14 text-white md:py-20">
        <div className="absolute inset-0">
          <Image src="/images/hero-bg/government-hero.webp" alt="" fill priority className="object-cover" sizes="100vw" />
      ...
      <div className="mx-auto grid max-w-5xl gap-8 px-6 py-12 md:grid-cols-[190px_1fr]">
        ...
        <div className="space-y-14 text-[17px] leading-8 text-gray-800">
          ...
          <section id="safety" className="scroll-mt-36">
            ...
            <p className="mt-4">공기질 정화, 냄새제거에 사용되는 약품은 해외 공인 시험기관의 검증을 거친 제품입니다. 민원인과 직원이 함께 머무는 공간이라 저희도 이 부분을 가장 신경 씁니다.</p>
          ...
          <section id="estimate" className="scroll-mt-36">
            ...
            <p>관공서청소 비용은 면적뿐 아니라 공간의 용도와 작업 조건에 따라 달라집니다.</p>
            <p className="mt-4">넓게 트인 로비와 책상·칸막이가 많은 사무공간은 같은 면적이라도 작업 방식이 다릅니다. 이용자가 많은 화장실과 가끔 사용하는 회의실도 필요한 관리가 같지 않습니다.</p>
            <p className="mt-4">찐청소는 이런 차이를 확인하고 필요한 인원과 장비·약품을 중심으로 견적을 산정합니다.</p>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">평수보다 실제 작업량을 살펴봅니다</h3>
            <p className="mt-2">집기가 많은 50평 공간은 비어 있는 100평 공간보다 작업에 시간이 더 걸릴 수 있습니다. 집기 자체를 청소하지 않더라도 좁은 통로와 가구 주변을 나누어 작업해야 하고, 장비가 들어가지 못하는 구간도 있기 때문입니다.</p>
            <p className="mt-2 text-[15px] text-gray-500">면적은 중요한 참고 자료입니다. 하지만 면적만으로 현장의 작업량까지 알 수는 없습니다.</p>
            ...
            <p className="mt-5 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">과업지시서나 청소 범위표가 있다면 함께 보내주세요. 요청하신 항목을 기준으로 작업 가능 범위와 견적을 검토합니다.</p>

            <h3 className="mt-8 text-lg font-bold text-brand-dark">정기청소는 인원과 작업 시간을 기준으로 합니다</h3>
            <p className="mt-3">정기청소는 필요한 인원과 시간당 작업 비용을 바탕으로 방문 주기와 회차별 작업 범위를 반영합니다.</p>
            <p className="mt-3">매번 관리할 곳과 일정 주기로 관리할 곳을 구분하는 것이 중요합니다.</p>
            <p className="mt-3">예를 들어 이용자가 많은 출입구와 화장실, 사용 빈도가 낮은 회의실을 모두 같은 주기로 관리할 필요는 없을 수 있습니다. 실제 이용 상황에 맞춰 관리 계획을 정합니다.</p>
          </section>
          ...
          <section id="scope" className="scroll-mt-36">
            ...
            <div className="mt-6 rounded-xl bg-gray-50 p-5">
              <p className="font-bold text-brand-dark">일반 청소와 구분해 확인할 항목</p>
              ...
              <p className="mt-4 text-[15px] text-gray-500">필요한 항목을 상담 시 함께 알려주시면 작업 가능 여부와 비용을 구분해 안내합니다.</p>
            </div>
          </section>
          ...
          <section id="extra" className="scroll-mt-36">
            ...
            <p>처음 정한 작업 범위를 넘어가거나 별도 공정이 필요한 경우에는 견적이 달라질 수 있습니다.</p>
            ...
            <p className="mt-5 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">견적을 비교할 때는 총금액과 함께 포함 구역, 제외 항목, 작업 인원과 시간을 살펴보세요. &lsquo;청사 전체 청소&rsquo;라는 같은 표현도 업체마다 뜻하는 범위가 다를 수 있습니다.</p>
          </section>
          ...
          <section id="process" className="scroll-mt-36">
            ...
            <p className="mt-2">면적, 오염 정도, 투입 인원, 작업 가능한 시간에 따라 달라집니다.</p>
            <p className="mt-2">같은 건물이라도 비어 있는 상태에서 한 번에 작업하는 경우와 운영 중 층별로 나누어 작업하는 경우는 소요 시간이 다릅니다.</p>
            <p className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">예상 시간은 현장 조건을 확인한 뒤 안내합니다.</p>
          </section>

          {/* 5. 전후사진/사례 */}
          <section id="cases" className="scroll-mt-36">
            <SectionTitle id="cases-title" kicker="05" title="작업 전후 사진과 결과 확인" />
            <p>청소 결과는 넓은 공간을 멀리서 찍은 사진만으로 판단하기 어렵습니다.</p>
            <p className="mt-4 font-bold text-brand-dark">다음과 같은 부분을 함께 살펴보면 작업 내용을 확인하기 좋습니다.</p>
            <ul className="mt-3 grid gap-2.5 sm:grid-cols-2">
              {caseChecklist.map(item => (
                <li key={item} className="rounded-xl border border-gray-100 bg-gray-50/60 px-4 py-3">{item}</li>
              ))}
            </ul>
            <p className="mt-5 text-[15px] text-gray-500">바닥은 반짝임만으로 평가하지 않습니다. 세척과 코팅은 다른 작업이므로, 요청한 오염이 제거됐는지와 작업 범위가 지켜졌는지를 확인하는 것이 중요합니다.</p>
            <p className="mt-2 text-[15px] text-gray-500">전후 사진이나 완료 자료가 필요한 기관은 촬영 가능 구역, 제출 형식, 필요한 내용을 상담 시 알려주세요. 제공 가능 범위와 방식을 미리 확인합니다.</p>
            <p className="mt-2 text-[15px] text-gray-500">개인정보가 보이는 서류, 화면, 민원인 등이 있는 곳은 촬영 제한 여부를 먼저 확인해야 합니다.</p>
          ...
          <section id="area" className="scroll-mt-36">
            ...
            <p className="mt-4 font-bold text-brand-dark">일정을 정할 때는 다음 사항을 함께 알려주세요.</p>
            <ul className="mt-3 grid gap-2.5 sm:grid-cols-2">
              {reservationChecklist.map(item => (
                <li key={item} className="rounded-xl border border-gray-100 bg-gray-50/60 px-4 py-3">{item}</li>
              ))}
            </ul>
            <p className="mt-5">야간이나 주말 작업이 필요하다면 희망 시간대를 말씀해 주세요. 현장 조건과 예약 상황에 따라 가능 여부를 안내합니다.</p>
            <p className="mt-2 text-[15px] text-gray-500">행사나 업무 재개 직전이라면 청소 종료뿐 아니라 바닥 건조와 마무리 확인에 필요한 시간도 고려하는 것이 좋습니다.</p>
          </section>
          ...
          <section id="checkup" className="scroll-mt-36">
            ...
            <p className="mt-2">완료 후에는 견적서나 과업 범위에 포함된 구역과 항목을 기준으로 확인합니다.</p>
            <p className="mt-2">청소 전 문제가 되었던 오염, 빠뜨리기 쉬운 모서리와 창틀, 이용자가 많은 공용 공간을 함께 살펴봅니다.</p>
            <p className="mt-2 text-[15px] text-gray-500">변색, 마모, 파손처럼 청소와 다른 조치가 필요한 상태는 구분해 안내합니다.</p>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">미흡한 부분은 위치와 상태를 알려주세요</h3>
            <p className="mt-2">작업 범위 안에서 추가 확인이 필요한 곳이 있다면 해당 구역과 상태를 알려주세요.</p>
            <p className="mt-2">작업 내용과 현장을 확인하여 후속 처리 방법을 안내합니다.</p>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">정기청소는 회차별 기준을 정합니다</h3>
            <p className="mt-2">정기관리에서는 매회 작업과 주기적으로 하는 작업을 구분해 두면 확인이 수월합니다.</p>
            <p className="mt-2">이용 인원이나 시설 운영 방식이 달라졌다면 청소 주기와 작업 시간을 다시 검토할 수 있습니다.</p>
            <p className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">한 번 정한 계획을 그대로 반복하기보다 실제 사용 상태에 맞추는 것이 중요합니다.</p>
          </section>

          {/* 8. 준비사항 */}
          <section id="prep" className="scroll-mt-36">
            <SectionTitle id="prep-title" kicker="08" title="작업 전 준비사항과 담당자 체크리스트" />
            <p>상담과 작업 전에 아래 내용을 정리해 주시면 진행이 수월합니다.</p>
            ...
            <p className="mt-5 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">기관마다 필요한 서류와 계약 조건이 다를 수 있습니다. 정해진 양식이나 참가 요건이 있다면 계약 전에 전달해 주셔야 대응 가능 여부를 확인할 수 있습니다.</p>
          </section>
          ...
          <section id="contact" className="scroll-mt-36">
            <div className="rounded-2xl bg-brand-dark p-7 text-white">
              <p className="text-xl font-bold">관공서청소 견적 문의</p>
              <p className="mt-3 text-white/80">기관명과 평수만으로는 현장을 충분히 알기 어렵습니다.</p>
              <p className="mt-2 text-white/80">민원인이 계속 오가는 공간인지, 사무 집기가 많은 곳인지, 주말에 전체를 비우고 작업할 수 있는지에 따라 필요한 준비가 달라집니다.</p>
