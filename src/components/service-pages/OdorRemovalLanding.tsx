...
const faqItems: [string, string][] = [
  ...
  ["배수구 냄새도 제거하나요?", "배수구 주변 오염과 설비 문제를 구분해 상담합니다. 배관 보수나 부품 교체가 필요한 경우에는 일반 청소·탈취와 별도로 안내합니다."],
    ...
    <article>
      ...
      <section className="bg-gradient-to-br from-brand-dark to-brand px-6 py-14 text-white md:py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 text-3xl font-black leading-tight md:text-5xl">냄새악취제거, 다시 나는 이유부터 살펴봅니다</h1>
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <p>청소해도 며칠 뒤 다시 느껴지는 냄새, 환기할 때는 괜찮다가 창문을 닫으면 올라오는 악취, 어느 방에서 시작되는지 알기 어려운 불편함.</p>
            <p>냄새 제거는 공간 전체에 같은 작업을 적용하기보다 발생 위치와 오염 상태부터 확인해야 합니다.</p>
            <p>찐청소는 냄새가 시작된 시점과 생활·공사 이력, 자재와 물품의 상태를 살펴 작업 범위를 안내합니다.</p>
            <p>방향제 향을 고르는 일보다, 왜 냄새가 남는지 확인하는 일부터 함께하겠습니다.</p>
          </div>
