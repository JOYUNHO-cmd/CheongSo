...
import { ServiceNextStep } from "@/components/service-pages/ServiceConnections";
    ...
    <article className={`${readability.landing} ${readability.enhanced}`}>
      ...
      <section className="relative flex min-h-[calc(66.667vw+680px)] flex-col overflow-hidden bg-gradient-to-br from-brand-dark to-brand px-6 py-14 text-white md:min-h-[max(650px,50vw)] md:justify-center md:py-20 lg:min-h-[max(620px,50vw)]">
        <div className="relative -mx-6 -mt-14 aspect-[3/2] md:absolute md:inset-0 md:m-0 md:aspect-auto">
          <Image src="/images/service-scenes/pest-treatment-scene.webp" alt="" fill className="scale-110 object-cover blur-2xl" sizes="25vw" />
          <div className="absolute inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:aspect-[3/2] md:w-3/4 md:-translate-x-1/2 md:-translate-y-1/2">
            <Image src="/images/service-scenes/pest-treatment-scene.webp" alt="" fill preload className="object-cover" sizes="(min-width: 768px) 75vw, 100vw" />
          </div>
        ...
        <div className="relative mx-auto my-auto w-full max-w-5xl pt-8 md:pt-0">
          ...
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <ReadingParagraph>벌레를 발견한 위치, 반복되는 시간과 공간 용도를 알려주세요. 소독업 신고를 마친 찐청소는 공간·표면 소독과 바퀴벌레·개미·빈대·모기, 쥐 방제를 구분해 상담합니다. 실제 진행한 소독 내용에 따른 소독증명서 발급도 가능합니다.</ReadingParagraph>
          </div>
      ...
      <div className={readability.layout}>
        ...
        <div className={`${readability.body} space-y-14 text-gray-800`}>
          ...
          <section id="estimate" className="scroll-mt-36">
            ...
            <ReadingParagraph>소독·방역 비용은 평수만으로 정하지 않습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4" breakAfter={["같은 면적이라도 "]}>같은 면적이라도 표면 소독이 필요한 공간과 해충이 발생한 공간은 작업 내용이 다릅니다. 해충의 종류와 발생 범위, 접근 조건에 따라서도 필요한 준비가 달라집니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4" breakAfter={["장비·약품을 중심으로 "]}>찐청소는 필요한 인원과 장비·약품을 중심으로 현장 작업량과 방문 횟수를 반영해 견적을 안내합니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">공간 소독과 해충 방제는 다른 작업입니다</h3>
            <ReadingParagraph className="mt-2">문손잡이와 공용 표면 등을 소독하는 작업과 바퀴벌레·빈대·쥐에 대응하는 방제는 목적과 방법이 다릅니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">&lsquo;방역 한 번&rsquo;이라는 표현만으로 모든 작업이 포함되는 것은 아닙니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">필요한 서비스를 구분해야 견적과 작업 결과도 정확하게 확인할 수 있습니다.</ReadingParagraph>
            ...
            <ReadingParagraph className="mt-5 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">이전에 다른 약품을 사용했거나 방제를 받은 적이 있다면 함께 알려주세요.</ReadingParagraph>

            <h3 className="mt-8 text-lg font-bold text-brand-dark">일회성 작업과 정기관리를 구분합니다</h3>
            <ReadingParagraph className="mt-2">한 번의 소독이 필요한지, 해충 발생을 확인하며 반복 관리할지에 따라 구성이 달라집니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">정기관리는 필요한 인원과 작업 시간, 대상과 방문 주기 등을 확인해 안내합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">표면 소독, 해충 확인, 추가 처리 중 매회 무엇을 하는지 계약 범위에 명시하는 것이 중요합니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="scope" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2 mb-6">벌레의 모습과 발견 장소, 횟수를 확인해 관리 대상을 정합니다. 물린 자국만으로 빈대라고 단정하지 않습니다. 약품·장비는 대상과 공간에 맞춰 선택하며, 어린이·반려동물과 식품 보호, 작업 후 출입 조건을 함께 안내합니다.</ReadingParagraph>
            <ReadingParagraph>찐청소는 아래 서비스를 현장 상태에 맞춰 상담합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4">모든 항목이 하나의 기본 견적에 포함되는 것은 아니며, 요청한 대상과 작업 구역을 구분합니다.</ReadingParagraph>
            ...
            <div className="mt-6 rounded-xl bg-gray-50 p-5">
              <ReadingParagraph className="font-bold text-brand-dark">청소·냄새 제거·보수는 구분합니다</ReadingParagraph>
              <ReadingParagraph className="mt-2 text-[15.5px]">소독이나 방제를 받는다고 다음 작업까지 자동으로 포함되는 것은 아닙니다.</ReadingParagraph>
              ...
              <ReadingParagraph className="mt-4 text-[15px] text-gray-500">필요한 항목을 함께 알려주시면 작업 가능 범위와 비용을 안내합니다.</ReadingParagraph>
            </div>
          ...
          <section id="extra" className={`${readability.extraCosts} scroll-mt-36`}>
            ...
            <ReadingParagraph>처음 정한 대상이나 구역보다 작업이 늘어나면 견적이 달라질 수 있습니다.</ReadingParagraph>
            ...
            <ReadingParagraph className="mt-2">해충 방제는 대상과 현장 상태에 따라 후속 확인이나 추가 작업이 필요할 수 있습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">처음 견적에 포함된 방문 횟수, 재방문 조건, 추가 비용과 관리 기간을 계약 전에 확인해 주세요.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">한 번 작업하면 다시는 발생하지 않는다고 약속하지 않습니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="process" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2">면적과 대상, 작업 구역과 방법, 준비 조건에 따라 달라집니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">작업 종료 시간과 사람이 다시 들어가거나 영업을 시작할 수 있는 시간은 다를 수 있습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">희망 이용 시간을 알려주시면 필요한 준비·작업·대기 조건을 함께 검토합니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="certificate" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2">찐청소는 소독업 신고를 완료했으며 소독증명서 발급이 가능합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">약품이나 장비를 독자 기술로 포장하기보다, 대상에 맞는 적용과 작업 내용 안내를 중요하게 생각합니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">실제 진행한 소독 내용을 기준으로 발급합니다</h3>
            <ReadingParagraph className="mt-2">소독증명서가 필요하면 시설명, 주소, 제출 목적과 필요한 정보를 상담 시 알려주세요.</ReadingParagraph>
            <ReadingParagraph className="mt-2">작업 내용에 맞춰 발급을 진행하며, 제출처에서 요구하는 별도 자료가 있다면 사전에 확인합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">증명서는 실제 소독 내역을 확인하는 자료이지, 공간에 해충이나 미생물이 전혀 없다는 보증서는 아닙니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">시설별 요구사항은 별도로 확인합니다</h3>
            <ReadingParagraph className="mt-2">법정 소독과 관련된 문의라면 시설의 종류와 규모, 용도 등을 알려주세요.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">의무 대상 여부와 주기를 모든 시설에 동일하게 안내하지 않습니다. 현행 기준과 제출처 요구사항에 맞는 별도 확인이 필요합니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">작업 사진과 안내 자료</h3>
            <ReadingParagraph className="mt-2">사진이나 작업 내역이 필요하면 제공 범위와 방식을 미리 확인해 주세요.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">사진만으로 소독 효과나 해충의 완전 제거를 증명할 수는 없으므로, 작업 내용과 이후 확인 결과를 구분해서 살펴봅니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="area" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-4">소독·방역은 공간 이용을 고려해 일정을 정해야 합니다.</ReadingParagraph>
          ...
          <section id="checkup" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2">공간 소독은 합의한 표면과 구역의 작업 내용을 확인합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">해충 방제는 작업 후 발견 위치와 빈도 등 현장 변화를 살펴야 합니다. 방문 직후의 모습만으로 장기 결과를 단정하지 않습니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">반복 발생은 원인과 작업 내용을 함께 봅니다</h3>
            <ReadingParagraph className="mt-2">해충이 다시 보이면 어느 위치에서 언제 발견했는지 알려주세요.</ReadingParagraph>
            <ReadingParagraph className="mt-2">남아 있던 개체인지, 외부에서 새로 유입됐는지 등 확인할 사항과 후속 작업을 검토합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">사진을 남길 수 있다면 무리해서 잡거나 접근하지 말고 안전한 거리에서 촬영해 주세요.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">설치·처리한 부위는 안내에 따라 관리합니다</h3>
            <ReadingParagraph className="mt-2">처리한 곳을 언제 닦아도 되는지, 설치물을 그대로 두어야 하는지 등은 작업 방법에 따라 달라집니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">임의로 약품을 더 사용하거나 설치물을 옮기기 전에 작업 안내를 확인해 주세요.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">후속 처리 조건은 계약 전에 확인합니다</h3>
            <ReadingParagraph className="mt-2">추가 확인과 재방문, 별도 작업의 조건을 미리 정합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">해충 재발 방지나 감염 예방 효과를 기간·조건 없이 보장하지 않습니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="prep" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-5 text-[15px] text-gray-500">약품을 미리 더 뿌리거나 모든 물건을 옮겨두실 필요는 없습니다. 대상에 따라 준비 방법이 다르므로 안내를 받은 뒤 정리해 주세요.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">약품은 냄새가 약하거나 익숙한 제품이라고 해서 모든 상황에서 안전한 것은 아닙니다. 작업 전후의 출입과 사용 조건을 따라주세요.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="contact" className="scroll-mt-36">
            <div className="rounded-2xl bg-brand-dark p-7 text-white">
              <ReadingParagraph className="text-xl font-bold">소독·방역 견적 문의</ReadingParagraph>
              <ReadingParagraph className="mt-3 text-white/80">몇 평인지와 함께, 어떤 관리가 필요한지 알려주세요.</ReadingParagraph>
              <ReadingParagraph className="mt-2 text-white/80">공간의 소독이 필요한지, 반복해서 보이는 해충이 있는지, 시설에 제출할 소독증명서가 필요한지에 따라 준비가 달라집니다.</ReadingParagraph>
