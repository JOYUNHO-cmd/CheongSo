...
const faqItems: [string, string][] = [
  ...
  ["후드청소를 하면 흡입력이 좋아지나요?", "청소만으로 성능 개선을 보장하지는 않습니다. 현재 상태를 알려주시면 청소 범위와 별도 점검이 필요한 사항을 구분해 상담합니다."],
    ...
    <article>
      ...
      <section className="relative overflow-hidden px-6 py-14 text-white md:py-20">
        <div className="absolute inset-0">
          <Image src="/images/hero-bg/hood-hero.webp" alt="" fill priority className="object-cover" sizes="100vw" />
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 text-3xl font-black leading-tight md:text-5xl">후드청소, 겉면보다 중요한 건 어디까지 닦느냐입니다</h1>
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <p>후드 겉면은 닦았는데 안쪽에는 기름때가 남아 있거나, 필터를 청소해도 손이 닿지 않는 곳이 신경 쓰인다면. 이제는 &lsquo;후드청소&rsquo;라는 이름보다 실제 작업 범위를 확인할 때입니다.</p>
            <p>찐청소는 음식점과 업소용 주방 후드의 구조, 오염 상태, 접근 조건을 살펴 청소 범위와 비용을 안내합니다.</p>
            <p>후드 본체와 필터, 기름받이 등 필요한 작업을 구분하고, 덕트나 배기설비까지 요청하시는 경우에는 수행 가능 여부를 별도로 확인합니다.</p>
