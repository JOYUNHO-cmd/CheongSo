...
const faqItems: [string, string][] = [
  ...
  ["그을음이 지워지면 탄 냄새도 없어지나요?", "반드시 그렇지는 않습니다. 눈에 보이는 오염과 냄새 상태를 따로 확인해야 합니다. 오염이 남아 있는 물품이나 자재의 추가 처리가 필요한 경우도 있습니다."],
    ...
    <article>
      ...
      <section className="relative overflow-hidden px-6 py-14 text-white md:py-20">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 text-3xl font-black leading-tight md:text-5xl">화재청소부터 복원까지, 필요한 작업을 순서대로 안내합니다</h1>
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <p>불은 꺼졌는데, 남은 공간을 어디서부터 정리해야 할지 막막하실 수 있습니다. 무엇을 버리고 무엇을 남길지, 청소로 해결할 수 있는지, 철거까지 해야 하는지부터 확인해야 합니다.</p>
            <p>찐청소는 화재 잔여물 수거와 필요한 철거부터 화재청소, 그을음·냄새 제거, 복원 인테리어, 준공청소까지 연결해 진행할 수 있습니다.</p>
            <p>현장마다 필요한 작업은 다릅니다. 청소할 부분과 철거·교체가 필요한 부분을 구분하고, 맡기실 범위에 맞춰 비용과 순서를 안내하겠습니다.</p>
          </div>
