...
const faqItems: [string, string][] = [
  ...
  ["겨울마다 베란다에 생기는 곰팡이도 상담할 수 있나요?", "네. 발생 위치와 반복 시기, 결로 상태를 알려주세요. 제거 가능한 범위를 살펴보고 단열이나 창호 등 별도 점검이 필요한 부분을 구분해 안내합니다."],
    ...
    <article>
      ...
      <section className="bg-gradient-to-br from-brand-dark to-brand px-6 py-14 text-white md:py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 text-3xl font-black leading-tight md:text-5xl">곰팡이제거, 보이는 얼룩과 다시 생기는 이유를 함께 살펴봅니다</h1>
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <p>닦아도 같은 자리에 다시 생기는 곰팡이. 벽지를 바꿔야 할지, 청소로 해결할 수 있을지부터 막막하셨죠.</p>
            <p>찐청소는 곰팡이가 발생한 위치와 범위, 표면 상태를 살펴 작업 방법을 안내합니다. 제거할 수 있는 오염과 자재 교체가 필요한 부분을 구분하고, 누수나 결로가 의심되면 별도 점검이 필요한 이유도 설명합니다.</p>
            <p>곰팡이에게 재방문 약속까지 받을 필요는 없으니까요. 제거 작업과 함께 이후 관리에 필요한 내용도 짚어드리겠습니다.</p>
          </div>
