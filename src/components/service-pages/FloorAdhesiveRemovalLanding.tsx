...
const faqItems: [string, string][] = [
  ...
  ["데코타일에 묻은 본드도 제거할 수 있나요?", "데코타일을 남길 것인지, 철거 후 바탕면의 본드를 제거할 것인지부터 구분해야 합니다. 표면 상태와 접착제를 확인해 작업 가능 범위를 안내합니다."],
    ...
    <article>
      ...
      <section className="relative overflow-hidden px-6 py-14 text-white md:py-20">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 text-3xl font-black leading-tight md:text-5xl">바닥본드제거, 새로 덮을 바닥인지 다시 쓸 바닥인지부터</h1>
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <p>카펫이나 바닥재를 걷어냈는데 본드가 그대로 남아 있나요? 끈적이는 접착제 때문에 걷기도 어렵고, 다음 공사를 어떻게 이어가야 할지 고민되실 수 있습니다.</p>
            <p>찐청소는 본드를 제거한 뒤 바닥을 어떻게 사용할지부터 확인합니다. 새 타일을 깔기 위한 작업인지, 기존 바닥을 드러내고 다시 사용하기 위한 작업인지에 따라 필요한 마감과 비용이 달라지기 때문입니다.</p>
            <p>마무리 세척은 기본으로 진행합니다. 기존 바닥을 재사용할 경우에는 남은 접착제와 오염을 더 세심하게 확인하며 세척합니다.</p>
            <p>바닥재 철거는 기본 비용에 포함되지 않습니다.</p>
          </div>
