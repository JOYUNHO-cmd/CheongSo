...
export const anyangWaxFaq: [string, string][] = [
  ...
  ["만안구와 동안구 모두 방문 상담이 가능한가요?", "평촌·범계·관양동이 있는 동안구와 석수동·안양1번가가 있는 만안구 현장 모두 주소와 희망 일정을 알려주시면 방문 가능 여부를 확인합니다. 구 이름만으로 출장 일정이나 비용을 확정하지 않으며 주차, 승강기, 반입 동선도 함께 확인합니다."],
