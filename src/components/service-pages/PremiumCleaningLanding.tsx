    ...
    <article className={`${readability.landing} ${readability.enhanced}`}>
      ...
      <section className="relative flex min-h-[calc(66.667vw+680px)] flex-col overflow-hidden bg-gradient-to-br from-brand-dark to-brand px-6 py-14 text-white md:min-h-[max(650px,50vw)] md:justify-center md:py-20 lg:min-h-[max(620px,50vw)]">
        <div className="relative -mx-6 -mt-14 aspect-[3/2] md:absolute md:inset-0 md:m-0 md:aspect-auto">
          <Image src="/images/hero-bg/premium-hero.webp" alt="" fill className="scale-110 object-cover blur-2xl" sizes="25vw" />
          <div className="absolute inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:aspect-[3/2] md:w-3/4 md:-translate-x-1/2 md:-translate-y-1/2">
            <Image src="/images/hero-bg/premium-hero.webp" alt="" fill priority className="object-cover" sizes="(min-width: 768px) 75vw, 100vw" />
          </div>
        ...
        <div className="relative mx-auto my-auto w-full max-w-5xl pt-8 md:pt-0">
          ...
          <div className="mt-5 max-w-3xl space-y-2 text-base sm:text-lg leading-relaxed text-white/90">
            <ReadingParagraph>신축 입주나 인테리어 이후 먼지뿐 아니라 새집 냄새도 신경 쓰이시나요? 찐청소 프리미엄청소는 정밀청소, 냄새 제거, 특허받은 약품과 장비를 활용한 새집증후군 관리를 함께 구성합니다. 현장별 적용 범위와 이용 재개 조건을 안내합니다.</ReadingParagraph>
          </div>
      ...
      <div className={readability.layout}>
        ...
        <div className={`${readability.body} space-y-14 text-gray-800`}>
          ...
          <section id="difference" className="scroll-mt-36">
            ...
            <ReadingParagraph>찐청소 프리미엄청소의 핵심은 세 가지입니다.</ReadingParagraph>
            ...
            <ReadingParagraph className="mt-4 text-[15px] text-gray-500">일반적인 공간 청소에 냄새와 새집증후군 관련 관리까지 함께 받고 싶은 분들을 위한 구성입니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">정밀청소의 차이는 작업 항목으로 설명합니다</h3>
            <ReadingParagraph className="mt-2">일반 청소를 대충 하고 프리미엄만 꼼꼼하게 한다는 뜻은 아닙니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">정밀청소는 고객님이 신경 쓰는 구간, 수납 공간과 틈새, 접근이 어려운 부위 등을 구체적으로 확인해 작업 계획에 반영합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">내부 세척과 탈거가 필요한 곳은 구조와 상태를 살펴 범위를 정합니다. 모든 부품을 분해하거나 모든 공간에 같은 시간을 투입하는 방식은 아닙니다.</ReadingParagraph>

            <ReadingParagraph className="mt-5 font-bold text-brand-dark">이런 경우에 상담해 보세요</ReadingParagraph>
            <ul className="mt-3 grid gap-2.5 sm:grid-cols-2">
              {consultTriggers.map(item => (
                <li key={item} className="rounded-xl border border-gray-100 bg-gray-50/60 px-4 py-3">{item}</li>
              ))}
            </ul>
            <ReadingParagraph className="mt-5 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">새 가구나 특정 자재에서 냄새가 느껴진다면 해당 위치와 반입 일정도 알려주세요. 적용 가능한 관리 범위를 함께 검토합니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="scope" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2 mb-6">새 수납장과 가구, 벽·바닥 마감 주변 등 냄새가 느껴지는 위치와 반입·시공 시점을 확인합니다. 정밀청소 구역과 냄새 관리 구역을 나눠 설명하며, 환기와 공간 이용 조건도 함께 안내합니다. 냄새 변화만으로 모든 실내 오염물질이 제거되었다고 판단하지 않습니다.</ReadingParagraph>
            <ReadingParagraph>프리미엄청소도 집마다 필요한 작업은 다릅니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4">공간의 구조와 재질, 오염 상태를 확인해 포함할 세부 항목을 정합니다. 아래 내용은 상담 시 확인하는 작업 구역입니다.</ReadingParagraph>
            ...
            <div className="mt-6 rounded-xl bg-gray-50 p-5">
              <ReadingParagraph className="font-bold text-brand-dark">프리미엄청소와 별도로 확인할 작업</ReadingParagraph>
              ...
              <ReadingParagraph className="mt-4 text-[15px] text-gray-500">프리미엄이라는 이름이 모든 청소와 공사를 포함한다는 뜻은 아닙니다. 필요한 항목은 견적에서 구분해 안내합니다.</ReadingParagraph>
            </div>
          ...
          <section id="odor" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2">냄새가 집 전체에서 느껴지는지, 특정 수납장이나 방에서 두드러지는지 살펴봅니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">신축인지, 최근 공사를 했는지, 새 가구가 들어왔는지 등 현장 정보도 함께 확인합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">냄새의 상태와 관리할 구역을 파악한 뒤 작업 범위를 정합니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">특허받은 약품과 장비를 활용합니다</h3>
            <ReadingParagraph className="mt-2">찐청소는 특허받은 약품과 장비를 활용해 냄새 제거와 새집증후군 관리를 진행합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">적용할 공간과 표면, 물품의 상태를 확인하고 제품·장비의 사용 조건에 맞춰 작업을 구성합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">특허 기술의 활용과 개별 현장의 관리 결과는 구분합니다. 모든 공간에 동일한 효과나 수치를 약속하지 않습니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">냄새 감소와 실내공기 상태는 구분합니다</h3>
            <ReadingParagraph className="mt-2">냄새가 줄었다는 사실만으로 모든 실내 오염물질이 제거됐다고 판단할 수는 없습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">찐청소는 정밀청소, 냄새 제거, 새집증후군 관리의 작업 내용을 구분해 안내합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">공기질 수치나 특정 물질의 저감 결과를 확인하고 싶다면 측정 제공 여부와 항목, 조건을 계약 전에 별도로 확인해 주세요.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">시공과 입주 후 관리는 연결됩니다</h3>
            <ReadingParagraph className="mt-2">작업 후에도 새 자재와 가구, 공간의 환기 조건 등이 실내 환경에 영향을 줄 수 있습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">작업에 사용한 제품과 방식에 맞는 환기, 출입과 공간 사용 조건을 확인하고 안내에 따라 관리하는 것이 중요합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">이 서비스는 실내 환경을 관리하는 작업이며, 질환의 예방·치료나 증상 개선을 보장하는 의료 서비스는 아닙니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="estimate" className="scroll-mt-36">
            ...
            <ReadingParagraph>비용은 평수만으로 정하지 않습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4" breakAfter={["필요한 인원과 정밀청소 작업량, ","사용 장비·약품과 현장 조건을 "]}>필요한 인원과 정밀청소 작업량, 관리할 구역, 사용 장비·약품과 현장 조건을 함께 확인합니다.</ReadingParagraph>
            ...
            <ReadingParagraph className="mt-5 text-[15px] text-gray-500">정밀청소·냄새 제거·새집증후군 관리가 견적에 어떻게 구성되는지 함께 안내합니다.</ReadingParagraph>
            ...
            <ReadingParagraph className="mt-5 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">추가 작업이 필요하면 내용과 비용을 확인한 뒤 진행 범위를 정합니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="process" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-2">면적과 세부 청소 범위, 오염 상태, 관리 방식과 작업 조건에 따라 달라집니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">청소가 끝나는 시간과 사람이 다시 들어가 생활할 수 있는 시간은 같다고 단정하지 않습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">희망 입주일에 맞춰 필요한 작업·환기·확인 시간을 함께 검토합니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="cases" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-5 text-[15px] text-gray-500">비슷한 위치와 조명에서 전후 상태를 살펴보면 결과를 확인하기 좋습니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">냄새와 새집증후군 관리는 작업 내역을 구분합니다</h3>
            <ReadingParagraph className="mt-2">어떤 구역에 어떤 관리가 진행됐는지 확인합니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">사진은 표면 상태를 보여주는 자료이지 공기질 개선 수치를 증명하는 자료는 아닙니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">측정이나 시험자료가 제공되는 경우에도 대상 항목과 조건, 해당 현장 결과인지 여부를 구분해서 확인해야 합니다.</ReadingParagraph>

            <h3 className="mt-6 text-lg font-bold text-brand-dark">확인 자료는 계약 전에 맞춥니다</h3>
            <ReadingParagraph className="mt-2">특허 관련 정보, 사용 제품·장비 정보, 작업 사진이나 측정 자료 등 필요한 항목이 있다면 상담 시 알려주세요.</ReadingParagraph>
            <ReadingParagraph className="mt-2 text-[15px] text-gray-500">제공 가능한 자료와 측정 서비스 포함 여부를 미리 확인합니다.</ReadingParagraph>
          ...
          <section id="area" className="scroll-mt-36">
            ...
            <ReadingParagraph className="mt-4">프리미엄청소는 청소 날짜뿐 아니라 공사, 가구 반입, 실제 입주 순서까지 함께 검토하는 것이 좋습니다.</ReadingParagraph>
            ...
            <ReadingParagraph className="mt-5 text-[15px] text-gray-500">관리 후 새로운 자재나 가구가 들어오는 경우도 있으므로, 일정을 숨김없이 알려주시면 적용할 범위를 정하는 데 도움이 됩니다.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">무조건 입주 전날이면 충분하다고 안내하지 않습니다. 사용 방식과 현장 조건에 맞는 여유 시간을 확인합니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="prep" className="scroll-mt-36">
            ...
            <ReadingParagraph className="font-bold text-brand-dark">작업 전에 알려주세요</ReadingParagraph>
            <ul className="mt-4 space-y-2.5">
              {prepItems.map(item => (
                <li key={item} className="flex items-start gap-2.5 rounded-xl border border-gray-100 px-4 py-3">
                  <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-brand" aria-hidden="true" />
            ...
            <ReadingParagraph className="mt-5 text-[15px] text-gray-500">식재료·식기·침구·개인 물품의 보관이나 보호가 필요한지는 적용할 작업에 맞춰 안내받아 준비해 주세요.</ReadingParagraph>

            <h3 className="mt-8 text-lg font-bold text-brand-dark">작업 후에는 사용 조건을 확인해 주세요</h3>
            <ReadingParagraph className="mt-2">환기와 출입, 표면 사용에 관한 안내는 사용 제품과 작업 방식에 따라 달라질 수 있습니다.</ReadingParagraph>
            <ReadingParagraph className="mt-2">안내받은 조건을 확인한 뒤 공간을 사용하고, 관리 후에도 신경 쓰이는 냄새나 이상이 있다면 위치와 상황을 알려주세요.</ReadingParagraph>
            <ReadingParagraph className="mt-4 rounded-xl bg-amber-50 p-4 text-[15.5px] leading-7">합의한 작업의 미흡한 부분과 추가 공사·가구 반입 후 새로 생긴 상태는 구분해 후속 처리 방법을 안내합니다.</ReadingParagraph>
          <BackToContents />
          </section>
          ...
          <section id="contact" className="scroll-mt-36">
            <div className="rounded-2xl bg-brand-dark p-7 text-white">
              <ReadingParagraph className="text-xl font-bold">프리미엄청소 견적 문의</ReadingParagraph>
              <ReadingParagraph className="mt-3 text-white/80">청소뿐 아니라 냄새와 새집증후군 관리까지 고민 중이라면, 현재 공간의 상태부터 알려주세요.</ReadingParagraph>
              <ReadingParagraph className="mt-2 text-white/80">신축 입주를 준비하는지, 리모델링 후 사용하는 공간인지, 새 가구가 들어온 뒤 냄새가 신경 쓰이는지에 따라 확인할 내용이 달라집니다.</ReadingParagraph>
