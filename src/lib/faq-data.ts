    ...
    qas: [
      {
        ...
        a: "평수만으로도 대략적인 견적은 가능하지만, 현장 상태(오염도, 자재 종류, 짐 유무)에 따라 작업 방식이 달라지기 때문에 정확한 건 무료로 현장 방문 후 안내해드립니다. 방문 견적 시 저희가 살펴보고 통화로 소통이 가능하니 현장에 계실 필요가 없습니다. 또한 15년간 수많은 현장을 다뤄온 경험으로, 전화 상담만으로도 상당히 근접한 견적을 바로 안내해드릴 수 있습니다.",
      },
      {
  ...
  },
  {
    ...
    qas: [
      ...
      },
      {
        ...
        a: "15년간 함께해온 전문팀 인력이 방문하며, 방문 전 담당팀 정보를 미리 안내해드리기 때문에 누가 오는지 알고 안심하고 맞이하실 수 있습니다.",
      },
    ],
  },
  {
