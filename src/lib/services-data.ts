...
export const serviceCategories: ServiceCategory[] = [
  ...
  },
  {
    ...
    items: ["소독&방역", "냄새악취제거", "곰팡이제거"],
  },
  {
    slug: "special",
    number: "05",
    title: "특수청소",
    description: "일반 청소로 해결되지 않는 특수한 상황을 처리합니다",
    descLine1: "일반 청소로 해결되지 않는",
    descLine2: "특수한 상황을 처리합니다",
  ...
  },
  {
    ...
    number: "06",
    title: "외부·공간청소",
    description: "건물 외벽부터 행사 공간, 석재까지 폭 넓게 관리합니다",
    descLine1: "건물 외벽부터 행사 공간,",
    descLine2: "석재까지 폭 넓게 관리합니다",
