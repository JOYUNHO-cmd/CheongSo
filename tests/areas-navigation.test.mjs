...
test('region directory links directly to the real Anyang page and is discoverable', async () => {
  ...
  assert.deepEqual(links.map(a => a.getAttribute('href')), ['/바닥-왁스-코팅/경기도-안양시/', '/주방청소/경기도-안양시/', '/쓰레기집청소/경기도-안양시/', '/신축준공청소/경기도-안양시/', '/쓰레기집청소/경기도-군포시/', '/인테리어청소/경기도-군포시/', '/바닥-왁스-코팅/경기도-군포시/', '/쓰레기집청소/경기도-안산시/', '/바닥-왁스-코팅/경기도-안산시/', '/인테리어청소/경기도-안산시/', '/공장청소/경기도-시흥시/', '/바닥-왁스-코팅/경기도-수원시/', '/사무실청소/경기도-수원시-영통구/', '/인테리어청소/경기도-수원시-영통구/', '/바닥-왁스-코팅/경기도-용인시/', '/인테리어청소/경기도-용인시/', '/사무실청소/경기도-의왕시/', '/바닥-왁스-코팅/경기도-의왕시/']);
